...
func _load_translations() -> void:
	...
	# 加载英文翻译
	localization_manager.load_translations("en", "res://addons/godot_ui_framework/examples/localization/translations/en.json")
	# 加载中文翻译
	localization_manager.load_translations("zh_CN", "res://addons/godot_ui_framework/examples/localization/translations/zh_CN.json")
	# 加载日文翻译
	localization_manager.load_translations("ja", "res://addons/godot_ui_framework/examples/localization/translations/ja.json")
