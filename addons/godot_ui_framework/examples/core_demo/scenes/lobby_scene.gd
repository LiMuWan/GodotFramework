...
## 大厅场景，复杂UI布局
const BattleTestData = preload("res://addons/godot_ui_framework/examples/core_demo/data/battle_test_data.gd")
...
func _on_ui_scene_component_initialized(data: Dictionary) -> void:
	if button_container == null:
		button_container = self.get_node("VBoxContainer/BottomBar/HBoxContainer/ButtonContainer")
